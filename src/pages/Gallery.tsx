    ...
    return (
        <div class="w-full py-10">
            <div class="w-full sm:w-10/12 mx-auto flex flex-wrap sm:flex-nowrap sm:gap-5 px-5">
                <div class="w-1/2 sm:w-1/4 bg-gray-100 h-64 relative" style={{'background-image':`url(${ImageOne})`,"background-size":"cover"}}>
                    <a href={ImageOne} download={ImageOne}>
                        <IoCloudDownloadOutline class="absolute top-5 right-5 text-xl" />
                    </a>
                </div>
                <div class="w-1/2 sm:w-1/4 bg-gray-100 h-64 relative" style={{'background-image':`url(${ImageTwo})`,"background-size":"cover"}}>
                    <a href={ImageTwo} download={ImageTwo}>
                        <IoCloudDownloadOutline class="absolute top-5 right-5 text-xl" />
                    </a>
                </div>
                <div class="w-1/2 sm:w-1/4 bg-gray-100 h-64 relative" style={{'background-image':`url(${ImageThree})`,"background-size":"cover"}}>
                    <a href={ImageThree} download={ImageThree}>
                        <IoCloudDownloadOutline class="absolute top-5 right-5 text-xl" />
                    </a>
                </div>
                <div class="w-1/2 sm:w-1/4 bg-gray-100 h-64 relative" style={{'background-image':`url(${ImageFour})`,"background-size":"cover"}}>
            ...
            <div class="w-full sm:w-10/12 mx-auto flex flex-wrap sm:flex-nowrap sm:gap-5 px-5 pt-5">
                <div class="w-1/2 sm:w-1/4 bg-gray-100 h-64 relative" style={{'background-image':`url(${ImageFive})`,"background-size":"cover"}}>
                    <a href={ImageFive} download={ImageFive}>
                        <IoCloudDownloadOutline class="absolute top-5 right-5 text-xl" />
                    </a>
                </div>
                <div class="w-1/2 sm:w-1/4 bg-gray-100 h-64 relative" style={{'background-image':`url(${ImageSix})`,"background-size":"cover"}}>
                    <a href={ImageSix} download={ImageSix}>
                        <IoCloudDownloadOutline class="absolute top-5 right-5 text-xl" />
                    </a>
                </div>
                <div class="w-1/2 sm:w-1/4 bg-gray-100 h-64 relative" style={{'background-image':`url(${ImageSeven})`,"background-size":"cover"}}>
                    <a href={ImageSeven} download={ImageSeven}>
                        <IoCloudDownloadOutline class="absolute top-5 right-5 text-xl" />
                    </a>
                </div>
                <div class="w-1/2 sm:w-1/4 bg-gray-100 h-64 relative" style={{'background-image':`url(${ImageEight})`,"background-size":"cover"}}>
